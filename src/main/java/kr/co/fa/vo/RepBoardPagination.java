...
public class RepBoardPagination {
	...
	public RepBoardPagination(int totalRows, int cp) {
	...
	public RepBoardPagination(int totalRows, int cp, int rows) {
		this.totalRows = totalRows;
		this.cp = cp;
		this.pages = 5;
		this.rows = rows;
	...
	public RepBoardPagination(int totalRows, int cp, int pages, int rows) {
		this.totalRows = totalRows;
		this.cp = cp;
		this.pages = pages;
		this.rows = rows;
